...
class CompatibilityProfileTest(unittest.TestCase):
    ...
    def test_report_has_exact_pinned_supported_names(self):
        ...
        self.assertEqual(report["counts"]["supported_root"], 89)
