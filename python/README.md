...
direct, fixed-shape, and bounded single-Wild additive/multiplicative remainder
matches are differential-tested against SymPy 1.14.0. Multi-Wild commutative
partitioning and broader recursive matching remain explicit future gaps.
