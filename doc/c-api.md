...
`src/capi/fortsym.h` is the public C contract (ABI version 82). It exposes opaque arena and
...
`fortsym_matrix_rank`, exact matrix inverse `fortsym_matrix_inverse`, and
matrix transpose `fortsym_matrix_transpose`;
