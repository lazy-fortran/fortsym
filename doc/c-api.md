...
`src/capi/fortsym.h` is the public C contract (ABI version 21). It exposes opaque arena and
...
raise/lower, and density metadata changes. The native library retains an
