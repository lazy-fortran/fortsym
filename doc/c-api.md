...
`src/capi/fortsym.h` is the public C contract (ABI version 22). It exposes opaque arena and
...
raise/lower, density metadata changes, and oriented metric volume forms. The native library retains an
