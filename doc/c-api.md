...
`src/capi/fortsym.h` is the public C contract (ABI version 81). It exposes opaque arena and
...
`fortsym_matrix_rank`, and exact matrix inverse `fortsym_matrix_inverse`;
