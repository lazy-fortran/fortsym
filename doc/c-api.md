...
`src/capi/fortsym.h` is the public C contract (ABI version 20). It exposes opaque arena and
...
signed Jacobian, covariant/reciprocal basis transport, and tensor slot
raise/lower. The native library retains an
