...
| Assumptions and conditions | sign facts, nested C/Python scopes, immutable Fortran contexts, `Q`/`ask` queries, and three-valued predicate properties | no public context | no public context | compound inference and returned conditions |
