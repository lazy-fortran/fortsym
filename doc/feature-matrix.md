...
| Linear and polynomial solve | partial: distinct verified roots for one equation in one symbol; exact univariate polynomial roots and verified scalar-linear fallback are public through C/Python/SymPy facades | no public operation | Yacas concrete method | `solveset`, domains/conditions, systems, inequalities, and broader polynomial roots |
