...
| Complex and algebraic domains | bounded `qqbar` atoms, scalar folding, exact `Re`/`Im`, conjugation, and lossless text IO | conversion only, algebraic atoms refused | partial | conversion and code generation |
