...
| Structural, simultaneous, exact-node substitution/replacement, and bounded wildcard matching | yes | conversion | conversion | callable/wildcard replacement, multi-Wild commutative partitioning, and rule-based applied-function substitution |
