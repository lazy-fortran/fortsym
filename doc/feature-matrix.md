...
| Structural, simultaneous, exact-node substitution, and bounded wildcard matching | yes | conversion | conversion | commutative wildcard remainder and rule-based applied-function substitution |
