...
| Complex and algebraic domains | bounded `qqbar` atoms, scalar folding, exact `Re`/`Im`, and conjugation | conversion only, algebraic atoms refused | partial | parsing, conversion, and code generation |
