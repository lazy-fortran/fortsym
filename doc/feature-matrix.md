...
| Connections and curvature | native fixed-3D subset: typed Christoffel, `covariant_diff`, first-slot `covariant_divergence`, chart/metric-owner geodesic residuals, Riemann, Ricci, scalar curvature, Einstein tensor, first- and second-Bianchi residuals from chart or coordinate-aware `metric_t`, plus metric compatibility and density-weight checks; dimension-aware spacetime metric `flat`/`sharp`, gradient, divergence, and wave/Laplace--Beltrami owner; C ABI and Python/SymPy views | no public nodes | no | pseudo-Riemannian sign-convention corpus, torsion/nonmetricity, geodesic solving/variational mechanics, arbitrary-dimensional tensor transport, and full differential comparison |
