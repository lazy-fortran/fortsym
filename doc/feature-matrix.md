...
| Structural, simultaneous, exact-node substitution/replacement, and bounded wildcard matching | yes | conversion | conversion | callable/commutative wildcard replacement and rule-based applied-function substitution |
