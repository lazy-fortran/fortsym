...
| Connections and curvature | native fixed-3D subset: typed `connection_t`, supplied affine coefficients, `connection_from_chart`/`connection_from_metric`, torsion, nonmetricity, typed Christoffel, `covariant_diff`, first-slot `covariant_divergence`, chart/metric-owner geodesic residuals, Riemann, Ricci, scalar curvature, Einstein tensor, first- and second-Bianchi residuals, plus metric compatibility and density-weight checks; C ABI 55 and Python/SymPy views | no public nodes | no | pseudo-Riemannian sign-convention corpus, geodesic solving/variational mechanics, arbitrary-dimensional tensor transport, and full differential comparison |
