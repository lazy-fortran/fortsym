...
The latest cache-only binding-level audit reports 3,664 agreements, 506 declared
differences, 7 unsupported outcomes, 74 timeouts, 61 errors, 2 unavailable
oracle rows, 194 oracle disagreements, and 462 oracle-missing bindings. The
v43-v45
...
parity, math3y, and Cartesian-primitive recoveries, with 15 independent tests.
The v37
