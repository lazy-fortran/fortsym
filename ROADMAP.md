...
The latest cache-only binding-level audit reports 3,879 agreements, 486 declared
differences, 7 unsupported outcomes, 75 timeouts, 61 errors, 2 unavailable
oracle rows, 195 oracle disagreements, and 322 oracle-missing bindings across
4,885 bindings. The v43-v87
...
binding, the heat-kernel `k3`, and a `gc_drift` Christoffel tensor. A trial
Levi-Civita native
lowering was
