    ...
    for operation in sorted(oracle_cases):
        ...
        if operation == "expand":
            ...
            actual = native.expand_complex(native_expression)
                ...
                "domain_asin_imaginary", "domain_sqrt_negative_square",
                "domain_asinh_imaginary",
                "domain_inverse",
