        ...
        results.append({
            ...
            "correct": (
                ...
                if (operation in ("count_ops", "free_symbols",
                                  ...
                                  "matrix_is_square", "matrix_is_diagonal") or
...
def main() -> None:
    ...
    for operation in (
        ...
        "matrix_rref_no_pivots", "matrix_rref_simplify", "matrix_rank_simplify", "matrix_trace", "matrix_is_diagonal", "matrix_is_symmetric", "matrix_len", "matrix_is_square", "matrix_column_constructor", "matrix_divide", "matrix_slice", "matrix_flat_index",
