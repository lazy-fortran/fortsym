        ...
        results.append({
            ...
            "correct": (
                ...
                if (operation in ("count_ops", "free_symbols",
                                  ...
                                  "matrix_is_square", "matrix_is_diagonal",
...
def main() -> None:
    ...
    for operation in (
        ...
        "matrix_rref_no_pivots", "matrix_rref_simplify", "matrix_rank_simplify", "matrix_trace", "matrix_is_diagonal", "matrix_is_symmetric", "matrix_is_zero_matrix", "matrix_is_upper", "matrix_is_lower", "matrix_is_anti_symmetric", "matrix_is_symbolic", "matrix_is_upper_hessenberg", "matrix_is_lower_hessenberg", "matrix_is_identity", "matrix_is_echelon", "matrix_len", "matrix_is_square", "matrix_column_constructor", "matrix_divide", "matrix_slice", "matrix_flat_index",
        ...
        *_ASSUMPTION_OPERATIONS, *_PREDICATE_OPERATIONS, "float_equality"
        ...
        if operation in _PREDICATE_OPERATIONS or operation in (
                "matrix_len", "matrix_is_square", "matrix_is_diagonal",
                ...
                "matrix_is_identity", "matrix_is_echelon"):
            scopes = ("warm_core",)
        elif (operation in _CONSTRUCTION_OPERATIONS or
              operation in _BOOLEAN_CONSTRUCTION_OPERATIONS):
