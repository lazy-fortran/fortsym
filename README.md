...
The v101 audit on 2026-08-03 uses native commit `c1186ba`, SymPy cache version
29, and Mathics3 10.0.1 installed as a UV tool. It reports 3,924 agreements,
477 declared differences, 7 unsupported outcomes, 75 timeouts, 61 backend
errors, 2 unavailable oracle rows, 197 oracle disagreements, and 284
oracle-missing bindings across 4,885 bindings. The cache-preserving pass took
82.29 seconds at about 1.53 GiB RSS; its all-warm UV compact-cache audit takes
0.99 seconds at about 489 MiB RSS. The preceding native refresh took 92.48
