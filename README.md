...
cache-only whole-corpus tally is 3,756 agreements, 477 declared differences, 7
unsupported outcomes, 74 timeouts, 61 errors, 2 unavailable oracle rows, 194
oracle disagreements, and 399 oracle-missing bindings. The v43-v52 batches add
...
recoveries, with 42 independent tests.
The v18
...
integral and removes one oracle disagreement. The v43-v52 batches raise the
score to 3,756 agreements and 477 differences, with 399 oracle-missing bindings;
the successful
