...
cache-only whole-corpus tally is 3,764 agreements, 477 declared differences, 7
unsupported outcomes, 74 timeouts, 61 errors, 2 unavailable oracle rows, 194
oracle disagreements, and 391 oracle-missing bindings. The v43-v54 batches add
...
recoveries, with 45 independent tests.
The v18
...
integral and removes one oracle disagreement. The v43-v54 batches raise the
score to 3,764 agreements and 477 differences, with 391 oracle-missing bindings;
the successful
