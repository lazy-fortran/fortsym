...
cache-only whole-corpus tally is 3,673 agreements, 502 declared differences, 7
unsupported outcomes, 74 timeouts, 61 errors, 2 unavailable oracle rows, 194
oracle disagreements, and 457 oracle-missing bindings. The v43-v48 batches add
...
cylinder-spectrum, math11y, and Mercier recoveries, with 22 independent tests.
The v18
...
integral and removes one oracle disagreement. The v43-v48 batches raise the
score to 3,673 agreements and 502 differences, with 457 oracle-missing bindings;
the successful
