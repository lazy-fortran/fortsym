...
cache-only whole-corpus tally is 3,664 agreements, 506 declared differences, 7
unsupported outcomes, 74 timeouts, 61 errors, 2 unavailable oracle rows, 194
oracle disagreements, and 462 oracle-missing bindings. The v43-v45 batches add
...
and Cartesian-primitive recoveries, with 15 independent tests. The v18
...
integral and removes one oracle disagreement. The v43-v45 batches raise the
score to 3,664 agreements and 506 differences, with 462 oracle-missing bindings;
the successful
