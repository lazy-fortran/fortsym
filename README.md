...
cache-only whole-corpus tally is 3,757 agreements, 477 declared differences, 7
unsupported outcomes, 74 timeouts, 61 errors, 2 unavailable oracle rows, 194
oracle disagreements, and 398 oracle-missing bindings. The v43-v53 batches add
...
recoveries, with 43 independent tests.
The v18
...
integral and removes one oracle disagreement. The v43-v53 batches raise the
score to 3,757 agreements and 477 differences, with 398 oracle-missing bindings;
the successful
