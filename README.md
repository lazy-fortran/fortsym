...
cache-only whole-corpus tally is 3,680 agreements, 502 declared differences, 7
unsupported outcomes, 74 timeouts, 61 errors, 2 unavailable oracle rows, 194
oracle disagreements, and 450 oracle-missing bindings. The v43-v49 batches add
...
recoveries, with 26 independent tests.
The v18
...
integral and removes one oracle disagreement. The v43-v49 batches raise the
score to 3,680 agreements and 502 differences, with 450 oracle-missing bindings;
the successful
