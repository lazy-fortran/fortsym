...
cache-only whole-corpus tally is 3,723 agreements, 488 declared differences, 7
unsupported outcomes, 74 timeouts, 61 errors, 2 unavailable oracle rows, 194
oracle disagreements, and 421 oracle-missing bindings. The v43-v51 batches add
...
recoveries, with 37 independent tests.
The v18
...
integral and removes one oracle disagreement. The v43-v51 batches raise the
score to 3,723 agreements and 488 differences, with 421 oracle-missing bindings;
the successful
