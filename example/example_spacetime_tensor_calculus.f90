program example_spacetime_tensor_calculus
    ...
    call assert_zero(spacetime_tensor_component(roundtrip, [1]) - vector_values(1), &
        "raise(lower(V)) component 1")
    call assert_zero(spacetime_tensor_component(roundtrip, [2]) - vector_values(2), &
    ...
    checked = simplify(spacetime_tensor_component(v_lower, [1]))
